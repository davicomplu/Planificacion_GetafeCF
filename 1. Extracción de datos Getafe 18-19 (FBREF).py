#Extracción de datos del Getafe 18-19 y guardar datos en archivos CSV (Web: FBREF)
...
ligas = [
    ('https://fbref.com/es/equipos/7848bd64/2018-2019/Estadisticas-de-Getafe', 'Getafe 18-19', '9'),
]
...
tablas_info = {
    ...
    'Premier League': {
        'xpath': '//*[@id="results2018-2019121_overall"]',
        'headers': [
