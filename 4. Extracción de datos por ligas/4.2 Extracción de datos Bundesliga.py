#Extracción de datos de los jugadores de los equipos de la Bundesliga (para cada equipo solo cambio el nombre del equipo en el código) (FBREF)
...
ligas = [
    ('https://fbref.com/es/equipos/0cdc4311/Estadisticas-de-Augsburg', 'Bundesliga', '20'),
]

# Información de las tablas a extraer
tablas_info = {
    'Estadística estándar': {
        'xpath': '//*[@id="stats_standard_20"]',
        'headers': [
    ...
    'Tipos de pases': {
        'xpath': '//*[@id="stats_passing_types_20"]',
        'headers': [
    ...
    'Tiempo jugado': {
        'xpath': '//*[@id="stats_playing_time_20"]',
        'headers': [
    ...
    'La Liga': {
        'xpath': '//*[@id="results2024-2025201_overall"]',
        'headers': [
