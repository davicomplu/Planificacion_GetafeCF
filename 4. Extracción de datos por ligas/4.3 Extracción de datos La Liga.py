#Extracción de datos de los jugadores de los equipos de La Liga (para cada equipo solo cambio el nombre del equipo en el código) (FBREF)
...
ligas = [
    ('https://fbref.com/es/equipos/8d6fd021/Estadisticas-de-Alaves', 'La Liga', '12'),
]

# Información de las tablas a extraer
tablas_info = {
    'Estadística estándar': {
        'xpath': '//*[@id="stats_standard_12"]',
        'headers': [
    ...
    'Tipos de pases': {
        'xpath': '//*[@id="stats_passing_types_12"]',
        'headers': [
    ...
    'Tiempo jugado': {
        'xpath': '//*[@id="stats_playing_time_12"]',
        'headers': [
    ...
    'La Liga': {
        'xpath': '//*[@id="results2024-2025121_overall"]',
        'headers': [
