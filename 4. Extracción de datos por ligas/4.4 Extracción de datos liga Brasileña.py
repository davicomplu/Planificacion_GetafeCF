#Extracción de datos de los jugadores de los equipos de la liga Brasileña (para cada equipo solo cambio el nombre del equipo en el código) (FBREF)
...
ligas = [
    ('https://fbref.com/es/equipos/2091c619/Estadisticas-de-Athletico-Paranaense', 'Série A', '24'),
]

# Información de las tablas a extraer
tablas_info = {
    'Estadística estándar': {
        'xpath': '//*[@id="stats_standard_24"]',
        'headers': [
    ...
    'Tipos de pases': {
        'xpath': '//*[@id="stats_passing_types_24"]',
        'headers': [
    ...
    'Tiempo jugado': {
        'xpath': '//*[@id="stats_playing_time_24"]',
        'headers': [
    ...
    'Série A, Série A': {
        'xpath': '//*[@id="results2024241_overall"]',
        'headers': [
