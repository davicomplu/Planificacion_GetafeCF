#Extracción de datos de los jugadores de los equipos de la Serie A (para cada equipo solo cambio el nombre del equipo en el código) (FBREF)
...
ligas = [
    ('https://fbref.com/es/equipos/922493f3/Estadisticas-de-Atalanta', 'Serie A', '11'),
]

# Información de las tablas a extraer
tablas_info = {
    'Estadística estándar': {
        'xpath': '//*[@id="stats_standard_11"]',
        'headers': [
    ...
    'Tipos de pases': {
        'xpath': '//*[@id="stats_passing_types_11"]',
        'headers': [
    ...
    'Tiempo jugado': {
        'xpath': '//*[@id="stats_playing_time_11"]',
        'headers': [
    ...
    'La Liga': {
        'xpath': '//*[@id="results2024-2025111_overall"]',
        'headers': [
