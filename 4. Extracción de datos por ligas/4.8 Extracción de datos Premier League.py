#Extracción de datos de los jugadores de los equipos de la Premier League (para cada equipo solo cambio el nombre del equipo en el código) (FBREF)
...
ligas = [
    ('https://fbref.com/es/equipos/361ca564/Estadisticas-de-Tottenham-Hotspur', 'EPL', '9'),
]

# Información de las tablas a extraer
tablas_info = {
    'Estadística estándar': {
        'xpath': '//*[@id="stats_standard_9"]',
        'headers': [
    ...
    'Tipos de pases': {
        'xpath': '//*[@id="stats_passing_types_9"]',
        'headers': [
    ...
    'Premier League': {
        'xpath': '//*[@id="results2024-202591_overall"]',
        'headers': [
