#Escalado jugadores Bundesliga (para cada equipo solo cambio el nombre del equipo en el código)
...
carpeta = 'C:\\Users\\david\\LIGAS\\Bundesliga\\Augsburg'
carpeta_salida = os.path.join(carpeta, 'Escalado_Augsburg')
