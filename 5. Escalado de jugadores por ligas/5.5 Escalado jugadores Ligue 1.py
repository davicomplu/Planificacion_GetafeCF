#Escalado jugadores Ligue 1 (para cada equipo solo cambio el nombre del equipo en el código)
...
carpeta = 'C:\\Users\\david\\LIGAS\\Ligue 1\\Angers'
carpeta_salida = os.path.join(carpeta, 'Escalado_Angers')
