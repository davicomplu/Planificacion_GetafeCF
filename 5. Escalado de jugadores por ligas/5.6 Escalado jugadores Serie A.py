#Escalado jugadores Serie A (para cada equipo solo cambio el nombre del equipo en el código)
...
carpeta = 'C:\\Users\\david\\LIGAS\\Serie A\\Atalanta'
carpeta_salida = os.path.join(carpeta, 'Escalado_Atalanta')
