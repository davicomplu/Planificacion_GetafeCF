#Escalado jugadores Serie B (2ª división italiana) (para cada equipo solo cambio el nombre del equipo en el código)
...
ruta_principal = 'C:\\Users\\david\\LIGAS\\Serie B Italia'
