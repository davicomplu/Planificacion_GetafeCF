#Escalado jugadores Premier League (para cada equipo solo cambio el nombre del equipo en el código)
...
carpeta = 'C:\\Users\\david\\LIGAS\\PL\\Arsenal'
carpeta_salida = os.path.join(carpeta, 'Escalado_Arsenal')
