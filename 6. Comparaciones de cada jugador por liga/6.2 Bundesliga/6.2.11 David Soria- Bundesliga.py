#David Soria- Bundesliga (creación de CSVs y generación de archivos excel)
...
excluir_archivos = ["La Liga.csv", "Marcadores y partidos.csv"]

for equipo in equipos:
    ruta_equipo = rf"C:/Users/david/LIGAS/Bundesliga/{equipo}"
    ...
    ruta_salida = r"C:/Users/david/LIGAS/Comparación/Bundesliga/PO. David Soria/"
...
directorio_csv = r"C:/Users/david/LIGAS/Comparación/Bundesliga/PO. David Soria/"

# Directorio donde se guardarán los archivos Excel
directorio_excel = r"C:/Users/david/OneDrive/Escritorio/MÁSTER/TFM/RESULTADOS COMPARACIÓN/PO. David Soria/Bundesliga/"
...
for archivo_csv in os.listdir(directorio_csv):
    if archivo_csv.endswith(".csv"):
        ...
        headers_relevantes = ['GC90', '% Salvadas', 'PaC%', '% Salvadas.1','PSxG+/-', 'Long. prom..1', '% Cmp.1', '% Cmp.2', '% Cmp.3', 'Err']
