#Jaime Mata- Championship PL (2ª división inglesa) (creación de CSVs y generación de archivos excel)
...
ruta_inicial = r"C:/Users/david/LIGAS/Getafe 18-19/Escalado_Getafe 18-19/Jugadores/DC. Jaime Mata/Jaime Mata.csv"
...
for col in columnas_relevantes:
    if col == "Jugador":
        fila_consolidada[col] = "Jaime Mata"
    else:
...
for equipo in equipos:
    ...
    ruta_salida = r"C:/Users/david/LIGAS/Comparación/Championship PL/DC. Jaime Mata/"
    os.makedirs(ruta_salida, exist_ok=True)
    archivo_salida = os.path.join(ruta_salida, f"DC. Jaime Mata-{equipo}.csv")
...
directorio_csv = r"C:/Users/david/LIGAS/Comparación/Championship PL/DC. Jaime Mata/"

# Directorio donde se guardarán los archivos Excel
directorio_excel = r"C:/Users/david/OneDrive/Escritorio/MÁSTER/TFM/RESULTADOS COMPARACIÓN/DC. Jaime Mata/Championship PL/"
