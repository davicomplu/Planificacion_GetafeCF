#Jorge Molina- Championship PL (2ª división inglesa) (creación de CSVs y generación de archivos excel)
...
ruta_inicial = r"C:/Users/david/LIGAS/Getafe 18-19/Escalado_Getafe 18-19/Jugadores/DC. Jorge Molina/Jorge Molina.csv"
df_inicial = pd.read_csv(ruta_inicial)

# Limpiar datos del archivo inicial
columnas_relevantes = ["Jugador", "Mín", "TA", "TR", '% de ganados', 'G-TP.1', 'Ast', 'SCA90', 'GCA90', '% Cmp.1', '% Cmp.2', '% Cmp.3', 'Exitosa%', 'TalArc/90', 'G/TalArc', 'npxG', 'Tkl+Int', 'Tkl%']
...
for col in columnas_relevantes:
    if col == "Jugador":
        fila_consolidada[col] = "Jorge Molina"
    else:
...
equipos = [
    "Blackburn Rovers", "Bristol City", "Burnley", "Cardiff City", "Coventry City", "Derby County", "Hull City", "Leeds United", "Luton Town", "Middlesbrough",
    "Millwall", "Norwich City", "Oxford United", "Plymouth Argyle", "Portsmouth", "Preston North End", "Queens Park Rangers", "Sheffield United", "Sheffield Wednesday", "Stoke City",
    "Sunderland", "Swansea City", "Watford", "West Bromwich Albion"
]

excluir_archivos = ["Série A, Série A.csv", "Marcadores y partidos.csv", "Portería avanzada.csv", "Porteros.csv"]

for equipo in equipos:
    ruta_equipo = rf"C:/Users/david/LIGAS/Championship PL/{equipo}/Escalado_{equipo}/"
    ...
    df_filtrado = df_equipo[df_equipo["Posc"].str.contains("DL", na=False)]
    ...
    ruta_salida = r"C:/Users/david/LIGAS/Comparación/Championship PL/DC. Jorge Molina/"
    os.makedirs(ruta_salida, exist_ok=True)
    archivo_salida = os.path.join(ruta_salida, f"DC. Jorge Molina-{equipo}.csv")
...
directorio_csv = r"C:/Users/david/LIGAS/Comparación/Championship PL/DC. Jorge Molina/"

# Directorio donde se guardarán los archivos Excel
directorio_excel = r"C:/Users/david/OneDrive/Escritorio/MÁSTER/TFM/RESULTADOS COMPARACIÓN/DC. Jorge Molina/Championship PL/"
...
for archivo_csv in os.listdir(directorio_csv):
    if archivo_csv.endswith(".csv"):
        ...
        archivo_excel = f"DC. Jorge Molina-{nombre_equipo}.xlsx"
        ...
        headers_relevantes = [ '% de ganados', 'G-TP.1', 'Ast', 'SCA90', 'GCA90', '% Cmp.1', '% Cmp.2', '% Cmp.3', 'Exitosa%', 'TalArc/90', 'G/TalArc', 'npxG', 'Tkl+Int', 'Tkl%']
