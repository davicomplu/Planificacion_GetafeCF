#Djené- Championship PL (2ª división inglesa) (creación de CSVs y generación de archivos excel)
...
ruta_inicial = r"C:/Users/david/LIGAS/Getafe 18-19/Escalado_Getafe 18-19/Jugadores/DFC. Djené/Djené.csv"
...
for equipo in equipos:
    ...
    ruta_salida = r"C:/Users/david/LIGAS/Comparación/Championship PL/DFC. Djené/"
    os.makedirs(ruta_salida, exist_ok=True)
    archivo_salida = os.path.join(ruta_salida, f"DFC. Djené-{equipo}.csv")
...
directorio_csv = r"C:/Users/david/LIGAS/Comparación/Championship PL/DFC. Djené/"

# Directorio donde se guardarán los archivos Excel
directorio_excel = r"C:/Users/david/OneDrive/Escritorio/MÁSTER/TFM/RESULTADOS COMPARACIÓN/DFC. Djené/Championship PL/"
...
for archivo_csv in os.listdir(directorio_csv):
    if archivo_csv.endswith(".csv"):
        ...
        archivo_excel = f"DFC. Djené-{nombre_equipo}.xlsx"
