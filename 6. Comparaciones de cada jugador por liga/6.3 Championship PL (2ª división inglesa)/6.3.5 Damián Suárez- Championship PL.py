#Damián Suárez- Championship PL (2ª división inglesa) (creación de CSVs y generación de archivos excel)
...
for col in columnas_relevantes:
    if col == "Jugador":
        fila_consolidada[col] = "Damián Suárez"
    else:
...
for equipo in equipos:
    ...
    ruta_salida = r"C:/Users/david/LIGAS/Comparación/Brasileirao/LD. Damián Suárez/"
    os.makedirs(ruta_salida, exist_ok=True)
    archivo_salida = os.path.join(ruta_salida, f"LD. Damián Suárez-{equipo}.csv")
...
directorio_csv = r"C:/Users/david/LIGAS/Comparación/Serie B Italia/LD. Damián Suárez/"

# Directorio donde se guardarán los archivos Excel
directorio_excel = r"C:/Users/david/OneDrive/Escritorio/MÁSTER/TFM/RESULTADOS COMPARACIÓN/LD. Damián Suárez/Serie B Italia/"
...
for archivo_csv in os.listdir(directorio_csv):
    if archivo_csv.endswith(".csv"):
        ...
        archivo_excel = f"LD. Damián Suárez-{nombre_equipo}.xlsx"
