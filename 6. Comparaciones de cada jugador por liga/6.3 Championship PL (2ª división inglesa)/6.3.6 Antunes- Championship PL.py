#Antunes- Championship PL (2ª división inglesa) (creación de CSVs y generación de archivos excel)
...
ruta_inicial = r"C:/Users/david/LIGAS/Getafe 18-19/Escalado_Getafe 18-19/Jugadores/LI. Vitorino Antunes/Vitorino Antunes.csv"
...
for col in columnas_relevantes:
    if col == "Jugador":
        fila_consolidada[col] = "Vitorino Antunes"
    else:
...
for equipo in equipos:
    ...
    df_filtrado = df_equipo[df_equipo["Posc"].str.contains("DF", na=False)]
    ...
    ruta_salida = r"C:/Users/david/LIGAS/Comparación/Championship PL/LI. Vitorino Antunes/"
    os.makedirs(ruta_salida, exist_ok=True)
    archivo_salida = os.path.join(ruta_salida, f"LI. Vitorino Antunes-{equipo}.csv")
...
directorio_csv = r"C:/Users/david/LIGAS/Comparación/Championship PL/LI. Vitorino Antunes/"

# Directorio donde se guardarán los archivos Excel
directorio_excel = r"C:/Users/david/OneDrive/Escritorio/MÁSTER/TFM/RESULTADOS COMPARACIÓN/LI. Vitorino Antunes/Championship PL/"
...
for archivo_csv in os.listdir(directorio_csv):
    if archivo_csv.endswith(".csv"):
        ...
        archivo_excel = f"LI. Vitorino Antunes-{nombre_equipo}.xlsx"
