#Nemanja Maksimović- Championship PL (2ª división inglesa) (creación de CSVs y generación de archivos excel)
...
ruta_inicial = r"C:/Users/david/LIGAS/Getafe 18-19/Escalado_Getafe 18-19/Jugadores/MC. Nemanja Maksimović/Nemanja Maksimović.csv"
...
for col in columnas_relevantes:
    if col == "Jugador":
        fila_consolidada[col] = "Nemanja Maksimović"
    else:
...
for equipo in equipos:
    ...
    ruta_salida = r"C:/Users/david/LIGAS/Comparación/Championship PL/MC. Nemanja Maksimović/"
    os.makedirs(ruta_salida, exist_ok=True)
    archivo_salida = os.path.join(ruta_salida, f"MC. Nemanja Maksimović-{equipo}.csv")
...
directorio_csv = r"C:/Users/david/LIGAS/Comparación/Championship PL/MC. Nemanja Maksimović/"

# Directorio donde se guardarán los archivos Excel
directorio_excel = r"C:/Users/david/OneDrive/Escritorio/MÁSTER/TFM/RESULTADOS COMPARACIÓN/MC. Nemanja Maksimović/Championship PL/"
...
for archivo_csv in os.listdir(directorio_csv):
    if archivo_csv.endswith(".csv"):
        ...
        archivo_excel = f"MC. Nemanja Maksimović-{nombre_equipo}.xlsx"
