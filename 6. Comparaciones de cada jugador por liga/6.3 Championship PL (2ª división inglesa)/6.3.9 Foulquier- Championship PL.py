#Foulquier- Championship PL (2ª división inglesa) (creación de CSVs y generación de archivos excel)
...
ruta_inicial = r"C:/Users/david/LIGAS/Getafe 18-19/Escalado_Getafe 18-19/Jugadores/MD. Dimitri Foulquier/Dimitri Foulquier.csv"
...
for col in columnas_relevantes:
    if col == "Jugador":
        fila_consolidada[col] = "Dimitri Foulquier"
    else:
...
for equipo in equipos:
    ...
    ruta_salida = r"C:/Users/david/LIGAS/Comparación/Championship PL/MD. Dimitri Foulquier/"
    os.makedirs(ruta_salida, exist_ok=True)
    archivo_salida = os.path.join(ruta_salida, f"MD. Dimitri Foulquier-{equipo}.csv")
...
directorio_csv = r"C:/Users/david/LIGAS/Comparación/Championship PL/MD. Dimitri Foulquier/"

# Directorio donde se guardarán los archivos Excel
directorio_excel = r"C:/Users/david/OneDrive/Escritorio/MÁSTER/TFM/RESULTADOS COMPARACIÓN/MD. Dimitri Foulquier/Championship PL/"
...
for archivo_csv in os.listdir(directorio_csv):
    if archivo_csv.endswith(".csv"):
        ...
        archivo_excel = f"MD. Dimitri Foulquier-{nombre_equipo}.xlsx"
