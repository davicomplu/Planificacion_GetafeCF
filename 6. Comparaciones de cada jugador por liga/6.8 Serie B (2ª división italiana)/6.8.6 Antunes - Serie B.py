#Antunes - Serie B (2ª división italiana) (creación de CSVs y generación de archivos excel)
...
for col in columnas_relevantes:
    if col == "Jugador":
        fila_consolidada[col] = "LI. Vitorino Antunes"
    else:
...
for equipo in equipos:
    ...
    ruta_salida = r"C:/Users/david/LIGAS/Comparación/Serie B Italia/LI. Vitorino Antunes/"
...
directorio_csv = r"C:/Users/david/LIGAS/Comparación/Serie B Italia/LI. Vitorino Antunes/"

# Directorio donde se guardarán los archivos Excel
directorio_excel = r"C:/Users/david/OneDrive/Escritorio/MÁSTER/TFM/RESULTADOS COMPARACIÓN/LI. Vitorino Antunes/Serie B Italia/"
