#Nemanja Maksimović - Serie B (2ª división italiana) (creación de CSVs y generación de archivos excel)
...
for equipo in equipos:
    ...
    ruta_salida = r"C:/Users/david/LIGAS/Comparación/Serie B Italia/MC. Nemanja Maksimović/"
    os.makedirs(ruta_salida, exist_ok=True)
    archivo_salida = os.path.join(ruta_salida, f"MI. Nemanja Maksimović-{equipo}.csv")
...
directorio_csv = r"C:/Users/david/LIGAS/Comparación/Serie B Italia/MC. Nemanja Maksimović/"

# Directorio donde se guardarán los archivos Excel
directorio_excel = r"C:/Users/david/OneDrive/Escritorio/MÁSTER/TFM/RESULTADOS COMPARACIÓN/MC. Nemanja Maksimović/Serie B Italia/"
