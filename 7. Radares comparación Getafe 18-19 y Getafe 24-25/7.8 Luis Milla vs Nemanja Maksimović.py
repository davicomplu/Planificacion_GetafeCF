#Luis Milla vs Nemanja Maksimović
...
file_path_1 = 'C:/Users/david/LIGAS/La Liga/Getafe/Escalado_Getafe/Jugadores/MC. Luis Milla/Luis Milla.csv'
data_1 = pd.read_csv(file_path_1)

# Leer el archivo CSV del segundo jugador
file_path_2 = 'C:/Users/david/LIGAS/Getafe 18-19/Escalado_Getafe 18-19/Jugadores/MC. Nemanja Maksimović/Nemanja Maksimović.csv'
...
axs['title'].text(0.70, 0.6, f"{player_name_2} (18/19)",
                  fontsize=24, fontweight='bold',
                  color='blue', ha='center', va='center')

escudo_ab_player2 = AnnotationBbox(escudo_liverpool_offset_img,
                                   (1.05, 0.6), frameon=False,
                                   xycoords="axes fraction")
